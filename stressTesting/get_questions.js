...
export default function () {
  ...
  const responses = http.batch([
    ['GET', `${BASE_URL}/qa/questions?product_id=8000`],
    ['GET', `${BASE_URL}/qa/questions?product_id=8001`],
    ['GET', `${BASE_URL}/qa/questions?product_id=8002`],
    ['GET', `${BASE_URL}/qa/questions?product_id=8003`],
  ]);
